...
pub(crate) fn likely_subtag(key: &str) -> Option<&'static str> {
    lookup(LIKELY_SUBTAGS, key)
}

pub(crate) fn language_alias(key: &str) -> Option<&'static str> {
    lookup(LANGUAGE_ALIASES, key)
}

pub(crate) fn territory_alias_first(key: &str) -> Option<&'static str> {
    lookup(TERRITORY_ALIASES, key)
}
